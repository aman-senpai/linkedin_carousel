...
const InfographicGenerator = dynamic(
    () => import("@/components/InfographicGenerator"),
    {
        loading: () => (
            <div className="flex items-center justify-center h-[600px] w-full bg-slate-50 dark:bg-slate-900 rounded-3xl border-2 border-dashed border-slate-200 dark:border-slate-800">
...
export default function Home() {
    ...
    const [postCaption, setPostCaption] = useState(
        "Check out this amazing carousel! 🚀",
    );
        ...
        if (savedData) {
            try {
                ...
                if (parsed.userProfileImage)
                    setUserProfileImage(parsed.userProfileImage);
            } catch (e) {
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            const index = Math.round(
                container.scrollLeft / (container.offsetWidth * 0.85),
            ); // 0.85 matches w-[85vw]
    ...
    const handleGenerateWithAI = async () => {
        ...
        try {
            if (activeTab === "carousel") {
                ...
                toast.info("AI Architects are drafting your layout...");
    ...
    const handleShuffleDesign = () => {
        ...
        const randomFont =
            FONT_OPTIONS[Math.floor(Math.random() * FONT_OPTIONS.length)].value;
            ...
            <div className="max-w-[1700px] mx-auto">
                ...
                <div className="w-full">
                    {activeTab === "carousel" ? (
                        ...
                        /* Infographic Mode manages its own consistent internal sidebar layout */
                        <InfographicGenerator
                            topic={topic}
                            setTopic={setTopic}
                            infographicData={infographicData}
                            setInfographicData={setInfographicData}
                            handleGenerate={handleGenerateWithAI}
                            isGenerating={isGenerating}
                            palette={palette}
                            setPalette={setPalette}
                            activeFont={activeFont}

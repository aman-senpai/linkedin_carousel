...
export const SLIDE_VARIANTS = {
    cover: ['centered', 'split', 'minimal', 'bold', 'card', 'photo', 'typographic', 'gradient', 'boxed', 'stripe', 'modern-split', 'magazine', 'editorial', 'asymmetric', 'overlay-text', 'bordered-photo', 'hero-image', 'glassmorphism', 'geometric', 'diagonal', 'rounded-card', 'minimal-vertical', 'neon', 'retro', 'brutalist', 'clean-white', 'dark-aesthetic', 'gradient-mesh', 'floating-elements', 'artistic-splatter'],
    ...
    'stats-grid': ['classic', 'grid', 'cards', 'bars', 'donut', 'split', 'dark'],
    'chart-radial': ['classic', 'card', 'gradient', 'dark', 'split', 'minimal'],
    'comparison': ['classic', 'cards', 'split', 'dark', 'minimal', 'grid'],
    'process-flow': ['classic', 'cards', 'timeline', 'dark', 'grid', 'split'],
    'timeline': ['classic', 'cards', 'minimal', 'dark', 'split', 'bold'],
};
